...
// this code is basd on https://github.com/caarlos0/env
// need to internalize it to avoid get un-exported functions
...
func get(fieldParams FieldParams, opts Options) (val string, err error) {
	...
	val, exists, isDefault = getOr(fieldParams.Key, fieldParams.DefaultValue, fieldParams.HasDefaultValue,
		opts.Environment)
